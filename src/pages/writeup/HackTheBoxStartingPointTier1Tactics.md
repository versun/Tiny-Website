...
![](/images/7ff4e6fe-397d-11ed-a709-5ac3aea65f93/53c95b4a-9f1d-462f-b2c7-95bfad1022ef.png) [^1]
...
![](/images/7ff4e6fe-397d-11ed-a709-5ac3aea65f93/417842d9-fa55-44fd-9524-e281c01ff50b.png) [^2]
...
![](/images/7ff4e6fe-397d-11ed-a709-5ac3aea65f93/3391d7d8-2a6e-4d66-9176-c2efb08cdf7e.png) [^3]

flag在C:\\Users\\Administrator\\Desktop路径下

Note:

[Tactics.pdf](/attachments/Tactics.pdf) [^4]
...
[^1]: -$ nmap -sC -sV -Pn $ip
    ...
    Nmap done: 1 IP address (1 host up ) scanned in 81.81 seconds
...
[^3]: -$ impacket-psexec -port 445 Administrator@$ip
...
[^4]: Tactics Writeup
    ...
    Starting Nmap 7.92 ( https://nmap. org ) at 2021-09-25 19:06 BST
